...
export default function Topnav() {
  ...
  const links = [{ href: "/", text: "Főoldal", svg: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
    ...
    //   )
    // },
    { href: "/reservation", text: "Foglalás", svg: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
