...
export default function ReservationPage() {
  ...
  return <div className={styles.container}>
      ...
      <Image src={"/foglalas.jpg"} alt="Balaton part naplemente" layout="fill" objectFit="cover" placeholder="blur" blurDataURL="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABQAAAAUCAYAAACNiR0NAAABKUlEQVQ4jZ2Tz0vDQBDGJx" priority={true} style={{
        zIndex: -2
      }}/>
      {/* dark overlay */}
        ...
        <motion.div className={styles.heroElements} initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: 15 }} transition={{ duration: 0.5, delay: 0.25, ease: "easeInOut" }}>
          ...
          <p>Köszönjük, hogy nálunk szállsz meg!</p>
        </motion.div>
      ...
      <div id="reserveInterface">
        ...
        {/* {isDreamHouseOpen
          ...
          : <div />} */}
        <ReserveInterfaceComponent title="Marosi Mókus" />
